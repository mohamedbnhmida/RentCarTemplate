...
class AppNavigation {
  static final List<GetPage> routes = [
    ...
    GetPage(name: AppRoutes.messages, page: () =>   MessageMobilePage()),
    GetPage(name: AppRoutes.messagesWeb, page: () =>   MessageWebPage()), 
   GetPage(name: AppRoutes.chats, page: () =>   ChatMobilePage()), 
  ];
